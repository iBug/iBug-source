...
I wrote [another article]({% link _posts/2018/2018-04-14-build-github-pages-with-travis-ci.md %}) two years ago about building with Travis CI, but from my experience in the past half year, GitHub Actions is, in all aspects, a better option than Travis CI.
...
In [my previous article]({% link _posts/2018/2018-04-14-build-github-pages-with-travis-ci.md %}) on building with Travis CI, we went through the steps of setting up a local build environment for our Jekyll site. We set up a Ruby development environment, installed `gem` and `bundle`, wrote a `Gemfile`, and built the Jekyll site locally.
