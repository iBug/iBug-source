...
With [BusyBox][busybox] that packs many common Unix & Linux utilities into one single binary. With BusyBox, you'll be able to create a mostly functional, yet still minimal Linux system.
...
echo -e "\nThis boot took $(cur -d' ' -f1 /proc/uptime) seconds\n"
exec /bin/sh
```
